...
\author{
    ...
    \subsection{Blockchain \& Decentralized Microinsurance}
    ...
    \subsection{Problems with Traditional Insurance}
    ...
    \subsection{Blockchain Advantages}
    ...
    \subsection{Benefits for Parametric \& Microinsurance}
